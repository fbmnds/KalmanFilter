// --------------------------------------------------------------------------------------
// Charting API for F# (version 0.5)
// --------------------------------------------------------------------------------------
...
module ChartTypes = 
    ...
    type GenericChart() = 
        ...
        let mutable legend = lazy new Legend()
        ...
        static member internal
         Create<'T when 'T :> GenericChart and 'T : (new : unit -> 'T)>(data) : 'T =
            let t = new 'T()
            t.Data <- data
            t
...
type FSharpChart =
    ...
    /// of each stacked element is always 100% of the Y
    /// axis.
    static member StackedArea100<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// proportion of each stacked element is always 100% of the
    /// Y axis.
    static member StackedBar100<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// proportion of each stacked element is always 100% of the
    /// Y axis.
    static member StackedColumn100<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Emphasizes the degree of change over time and shows the
    /// relationship of the parts to a whole.
    static member Area<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Illustrates comparisons among individual items.
    static member Bar<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Uses a sequence of columns to compare values across categories.
    static member Column<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Similar to the Pie chart type, except that it has
    /// a hole in the center.
    static member Doughnut<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// drawing time of a series that contains a very large
    /// number of data points.
    static member FastLine<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// the drawing time of a series that contains a very
    /// large number of data points.
    static member FastPoint<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Displays in a funnel shape data that equals 100% when
    /// totaled.
    static member Funnel<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// and direction of the lines are dependent on the action
    /// of the price value.
    static member Kagi<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Illustrates trends in data with the passing of time.
    static member Line<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Shows how proportions of data, shown as pie-shaped pieces,ÿcontribute to
    /// the data as aÿwhole.
    static member Pie<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Uses points to represent data points.
    static member Point<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// A circular graph on which data points are displayed using
    /// the angle, and the distance from the center point.
    static member Polar<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Displays data that, when combined, equals 100%.
    static member Pyramid<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// A circular chart that is used primarily as a data
    /// comparison tool.
    static member Radar<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// and direction of the lines are dependent on the action
    /// of the price value.
    static member Renko<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// A Line chart that plots a fitted curve through each
    /// data point in a series.
    static member Spline<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// An Area chart that plots a fitted curve through each
    /// data point in a series.
    static member SplineArea<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// An Area chart that stacks two or more data series
    /// on top of one another.
    static member StackedArea<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Displays series of the same chart type as stacked bars.
    static member StackedBar<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Used to compare the contribution of each value to a
    /// total across categories.
    static member StackedColumn<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// horizontal lines to connect the data points in a series
    /// forming a step-like progression.
    static member StepLine<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
    ...
    /// Displays a series of vertical boxes, or lines, that reflect
    /// changes in price values.
    static member ThreeLineBreak<'TX, 'TYValues, 'TY when 'TX :> IConvertible and 'TY :> IConvertible and 'TYValues :> seq<'TY>>(xvalues:seq<'TX>, yvalues:'TYValues) = 
...
module ChartStyleExtensions = 
    ...
    type AreaProperties() = 
        member area.AxisX<'T when 'T :> GenericChart>(?Enabled, ?LabelStyle, ?IsMarginVisible, ?Maximum, ?Minimum, ?MajorGrid, ?MinorGrid, ?MajorTickMark, ?MinorTickMark) = 
          fun (ch:'T) -> 
        ...
        member area.AxisY<'T when 'T :> GenericChart>(?Enabled, ?LabelStyle, ?IsMarginVisible, ?Maximum, ?Minimum, ?MajorGrid, ?MinorGrid, ?MajorTickMark, ?MinorTickMark) = 
          fun (ch:'T) -> 
        ...
        member area.AxisX2<'T when 'T :> GenericChart>(?Enabled, ?LabelStyle, ?IsMarginVisible, ?Maximum, ?Minimum, ?MajorGrid, ?MinorGrid, ?MajorTickMark, ?MinorTickMark) = 
          fun (ch:'T) -> 
            //ch.Area.AxisX <- new Axis(null, AxisName.X)
        ...
        member area.AxisY2<'T when 'T :> GenericChart>(?Enabled, ?LabelStyle, ?IsMarginVisible, ?Maximum, ?Minimum, ?MajorGrid, ?MinorGrid, ?MajorTickMark, ?MinorTickMark) = 
          fun (ch:'T) -> 
            //ch.Area.AxisY <- new Axis(null, AxisName.Y)
